/*! angular-wakanda - v0.4.2 - 2015-03-26 */
        ...
        var NgWakEntityAbstractPrototype = {
            init: function(wafEntity) {
                ...
                wafEntity.getDataClass().getAttributes().forEach(function(attr) {
                    if ("storage" === attr.kind) Object.defineProperty(this, attr.name, {
                        enumerable: true,
                        configurable: true,
                        get: function() {
                    ...
                    }); else if ("relatedEntity" === attr.kind) Object.defineProperty(this, attr.name, {
                        enumerable: true,
                        configurable: true,
                        get: function() {
                            if (this.$_entity[attr.name] && this.$_entity[attr.name].relEntity && "undefined" !== typeof this.$_entity[attr.name].relEntity.getKey()) return ds[this.$_entity[attr.name].relEntity.getDataClass().getName()].$refCache.getCachedNgWakEntity(this.$_entity[attr.name].relEntity);
                        },
                    ...
                    }); else if ("relatedEntities" === attr.kind) ;
                }.bind(this));
            },
            $key: function() {
        ...
        NgWakEntityCache.prototype.getCachedNgWakEntity = function(wafEntity) {
            ...
            if (wafEntity.isNew() && this.entitiesByKey[wafEntity.$_tempUUID]) return this.entitiesByKey[wafEntity.$_tempUUID]; else if (this.entitiesByKey[wafEntity.getKey()]) return this.entitiesByKey[wafEntity.getKey()]; else {
                ...
                if (wafEntity.getDataClass().$_relatedAttributes && wafEntity.getDataClass().$_relatedAttributes.length > 0) wafEntity.getDataClass().$_relatedAttributes.forEach(function(attr) {
                    ...
                    if ("relatedEntity" === attr.kind && wafEntity[attr.name] && wafEntity[attr.name].relEntity) var nestedEntity = ds[wafEntity[attr.name].relEntity.getDataClass().getName()].$refCache.getCachedNgWakEntity(wafEntity[attr.name].relEntity);
                }.bind(this));
