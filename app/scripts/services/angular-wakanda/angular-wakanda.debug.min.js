/*! angular-wakanda - v0.4.2 - 2015-03-27 */
                    ...
                    if ("relatedEntity" === attr.kind) Object.defineProperty(this, attr.name, {
                        ...
                        get: function() {
                            if (this.$_entity[attr.name] && this.$_entity[attr.name].relEntity && "undefined" !== typeof this.$_entity[attr.name].relEntity.getKey()) return ds[this.$_entity[attr.name].relEntity.getDataClass().getName()].$refCache.getCachedNgWakEntity(this.$_entity[attr.name].relEntity); else if (this.$_entity[attr.name] && null === this.$_entity[attr.name].relEntity && "undefined" !== typeof this.$_entity[attr.name].relKey) {
                                ...
                                if (cachedEntity) return cachedEntity; else ;
                            } else ;
                        },
                        ...
                        configurable: true,
                        get: function() {
                            if ("undefined" !== typeof this.$_entity[attr.name].$_tempValue) return this.$_entity[attr.name].$_tempValue; else return this.$_entity[attr.name].getValue();
                        },
                        set: function(newValue) {
                            rootScopeSafeApply(function() {
