/*! angular-wakanda-connector - v0.0.6 - 2014-03-31 */
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject, currentDataClass) {
            ...
            for (key in attributes) if ("storage" === attributes[key].kind) if ("image" === attributes[key].type) {
            ...
            } else ngWakEntityNestedObject[key] = manage1nRelationShips(entity[key], currentDataClass); else if ("relatedEntities" === attributes[key].kind) ngWakEntityNestedObject[key] = isEntityWafEntity ? entity[key].getRawValue() : entity[key]; else if ("relatedEntity" === attributes[key].kind) {
