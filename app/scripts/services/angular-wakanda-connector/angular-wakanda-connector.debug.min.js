/*! angular-wakanda-connector - v0.0.8 - 2014-04-10 */
        ...
        $$toJSON = function() {
            var getCleanObject = function(obj) {
                ...
                if (obj instanceof Array) {
                    ...
                    tmp = {};
                    for (key in obj) if (obj.hasOwnProperty(key) && "$_entity" !== key) if (obj[key] instanceof Array) tmp[key] = getCleanObject(obj[key]); else if (obj[key] && !obj[key].$_deferred) tmp[key] = obj[key];
                }
                return tmp;
            };
