...
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var transform = {
            queryEventToNgWakEntityCollection: function(event, onlyOne) {
                ...
                true !== onlyOne) {
                    ...
                    result.$_collection = event.result, result.$fetch = $$fetch, result.$add = $$add;
            ...
            asyncResult: function(data, result, promise) {
                ...
                if (data instanceof Array) {
                    ...
                    result.$_collection = data.$_collection, result.$fetch = $$fetch, result.$add = $$add, 
        ...
        var $$fetch = function(options, mode) {
            ...
            return wakOptions.onSuccess = function(event) {
                rootScopeSafeApply(function() {
                    ...
                    console.log("onSuccess", "processedEvent", event), deferred.resolve(event);
                });
            }, wakOptions.onError = function(event) {
                rootScopeSafeApply(function() {
                    console.error("onError", event), deferred.reject(event);
                });
        ...
        var $$find = function(options) {
            ...
            return deferred = $q.defer(), result.$promise = deferred.promise, console.log("RESULT", result), 
