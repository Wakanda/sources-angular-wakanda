(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var init = function(catalog) {
            console.log(">wakConnectorService init"), wakToAngular.prepareWAF();
            var deferred = $q.defer();
            if ("string" !== typeof catalog || "*" === catalog || "" === catalog) catalog = null;
            if (null === ds) new WAF.DataStore({
                onSuccess: function(event) {
                    ds = event.dataStore, wakToAngular.transformDatastore(ds), console.log(">wakConnectorService init > success", event, "ds", ds), 
                    deferred.resolve(ds);
                },
                onError: function(event) {
        ...
        var wakToAngular = {
            ...
            transformDatastore: function(dataStore) {
                ...
                for (dataClass in dataStore) if (dataStore.hasOwnProperty(dataClass) && "_private" !== dataClass) wakToAngular.transformDataClass(dataStore[dataClass]);
                console.groupEnd();
            },
