/*! angular-wakanda-connector - v0.0.6 - 2014-04-02 */
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", "$http", function($q, $rootScope, $http) {
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject, currentDataClass) {
            ...
            if (null === entity) return; else if (false === isEntityWafEntity) if (entity.__deferred) {
                ngWakEntityNestedObject.$_deferredUri = entity.__deferred.uri;
                ngWakEntityNestedObject.$fetch = function() {
                    console.warn("$fetch on deferred not yet implemented");
                };
            ...
            for (key in attributes) if ("storage" === attributes[key].kind || "calculated" === attributes[key].kind) {
                ...
                if (entity[key] && entity[key].__ENTITIES) ngWakEntityNestedObject[key] = transform.jsonResponseToNgWakEntityCollection(attributes[key].getRelatedClass(), entity[key].__ENTITIES); else if (!ngWakEntityNestedObject.$_deferredUri) ngWakEntityNestedObject[key] = [];
