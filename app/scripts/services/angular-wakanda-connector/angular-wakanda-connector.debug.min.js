/*! angular-wakanda-connector - v0.0.0 - 2014-02-28 */
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject, currentDataClass) {
            ...
            if (false === isEntityWafEntity) ngWakEntityNestedObject.$_entity = currentDataClass.newEntity(entity); else ngWakEntityNestedObject.$_entity = entity;
        ...
        var $$find = function(options) {
            ...
            wakOptions.onSuccess = function(event) {
                rootScopeSafeApply(function() {
                    console.log("onSuccess", "originalEvent", event), transform.queryEventToNgWakEntityCollection(event, onlyOne), 
                    transform.asyncResult(event.result, result, deferred.promise), updateQueryInfos(result, result.$_collection._private.pageSize, 0, query), 
