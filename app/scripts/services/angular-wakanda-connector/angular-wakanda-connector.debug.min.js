/*! angular-wakanda-connector - v0.0.5 - 2014-03-06 */
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject, currentDataClass) {
            ...
            } else ngWakEntityNestedObject[key] = isEntityWafEntity ? entity[key].getValue() : entity[key]; else if ("relatedEntities" === attributes[key].kind) ngWakEntityNestedObject[key] = isEntityWafEntity ? entity[key].getRawValue() : entity[key]; else if ("relatedEntity" === attributes[key].kind) {
