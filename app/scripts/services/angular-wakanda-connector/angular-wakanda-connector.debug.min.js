    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var $$create = function(pojo) {
            ...
            reccursiveFillNgWakEntityFromEntity(entity, ngWakEntity); else {
                ...
                console.log("WAF.EntityAttributeSimple", key, pojo[key]), entity[key] instanceof WAF.EntityAttributeSimple) console.log("WAF.EntityAttributeSimple", true), 
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject) {
            ...
            for (key in attributes) if ("storage" === attributes[key].kind) ngWakEntityNestedObject[key] = entity[key].getValue(); else if ("relatedEntities" === attributes[key].kind) ngWakEntityNestedObject[key] = entity[key].getRawValue(); else if (entity[key].relEntity) ngWakEntityNestedObject[key] = new (NgWakEntityClasses[entity[key].relEntity.getDataClass().$name])(), 
            ngWakEntityNestedObject[key].$_entity = entity[key].relEntity, reccursiveFillNgWakEntityFromEntity(entity[key].relEntity, ngWakEntityNestedObject[key]);
        };
