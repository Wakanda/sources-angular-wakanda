/*! angular-wakanda-connector - v0.0.11 - 2014-04-30 */
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", "$http", function($q, $rootScope, $http) {
        ...
        var $fetchOnNestedCollection = function(options, mode) {
            ...
            if (!that.$_collection) {
                ...
                wakOptions.top = options.pageSize = "undefined" === typeof options.pageSize ? this.$query ? this.$query.pageSize : 40 : options.pageSize;
                rootScopeSafeApply(function() {
                    that.$fetching = true;
                });
