...
(function(exports, global) {
    ...
    wakConnectorModule.factory("wakConnectorService", [ "$q", "$rootScope", function($q, $rootScope) {
        ...
        var transform = {
            ...
            asyncResult: function(data, result, promise) {
                ...
                if (data instanceof Array) {
                    ...
                    if (collectionMethods.length > 0) for (i = 0; i < collectionMethods.length; i++) result[collectionMethods[i]] = data[collectionMethods[i]];
        ...
        var reccursiveFillNgWakEntityFromEntity = function(entity, ngWakEntityNestedObject, currentDataClass) {
            ...
            for (key in attributes) if ("storage" === attributes[key].kind) ngWakEntityNestedObject[key] = isEntityWafEntity ? entity[key].getValue() : entity[key]; else if ("relatedEntities" === attributes[key].kind) {
                ...
                if (isEntityWafEntity) reccursiveFillNgWakEntityFromEntity(entity[key].relEntity, ngWakEntityNestedObject[key], entity[key].relEntity.getDataClass()); else {
        ...
        var $$fetch = function(options, mode) {
            ...
            if ("undefined" !== typeof options.start) skip = options.start;
